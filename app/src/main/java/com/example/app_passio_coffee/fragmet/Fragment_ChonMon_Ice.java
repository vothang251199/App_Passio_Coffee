...
public class Fragment_ChonMon_Ice extends Fragment {

    private RecyclerView mRecyclerView;
    private AdapterMon adapterMon;
    private View mView;

    public Fragment_ChonMon_Ice() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        mView =  inflater.inflate(R.layout.fragment_chonmon_ice, container, false);

        mRecyclerView = mView.findViewById(R.id.rcv_chonmon_ice);
